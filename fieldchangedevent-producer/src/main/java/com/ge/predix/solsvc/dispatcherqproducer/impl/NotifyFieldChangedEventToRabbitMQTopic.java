 ...
 * @author 212367843
 */
public class NotifyFieldChangedEventToRabbitMQTopic
        implements NotifyFieldChangedEvent
{

    /* (non-Javadoc)
     * @see com.ge.predix.dispatcherqproducer.api.sendFieldChangedEvent#sendFieldChangedEvent(com.ge.predix.solution.service.fieldchanged.FieldChangedEvent)
     */
    @Override
